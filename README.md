...
- 👋 Hi, I am `@iamabd55` (Abdul Rehman Ali)
- 🎓 CS student at COMSATS University Islamabad, Lahore Campus
- 🚀 I build full-stack web apps — from UI to deployment
- 🛠️ Currently transitioning into **.NET / C#** development
- 🤝 Open to internship opportunities in software engineering
- 🔗 LinkedIn: `https://www.linkedin.com/in/iamabd55/`
...
`Also used:` Supabase, Zod, Resend, Recharts
...
- Redis, Socket.io for real-time applications

---

### Featured Project

- [`Al Nasir Motors`](https://github.com/iamabd55/chtc_kama_pakistan) — Production dealership platform for a commercial vehicle client. Built with Next.js, Supabase, TypeScript, and Tailwind CSS. Features an inquiry tracker, analytics dashboard, testimonials system, and transactional email via Resend. Live at [alnasirmotors.com](https://alnasirmotors.com) and ranking on Google.
